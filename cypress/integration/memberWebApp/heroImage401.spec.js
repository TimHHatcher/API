...
describe('API - Hero Image', () => {
	...
	it('Hero image 401 Response', () => {
		cy.get('@loginInfo').then(response => {
			...
			cy.request({
				method: 'GET',
				url: 'https://z8m0fpo6yl.execute-api.us-east-1.amazonaws.com/v1/member/FakeMember/hero-image/eyJtZW1iZXJJZCI6IjAwMzJDMDAwMDBiV1RHd1FBTyIsIm1vZHVsZUlkIjoiNTAwMkMwMDAwMEFhTnlDUUFWIiwibGVzc29uUGhsdWlkIjoiM0xTNUU5NUY5N0UwMERFNyIsInNob3VsZERpc3BsYXlTdXJ2ZXkiOnRydWUsIm9yaWdpbiI6InBhY2tfaGVhbHRoX3BvcnRhbCJ9',
				headers: {
					brand: 'Pack Health',
